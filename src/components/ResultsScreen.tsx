    ...
    >
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-card/50 backdrop-blur-sm rounded-[2rem] shadow-[0_8px_32px_rgba(0,0,0,0.4)] p-8 mb-8 relative border border-border/50">
          ...
          <div ref={chartRef} className="aspect-square max-w-md mx-auto mb-8 bg-background/50 backdrop-blur-sm p-4 rounded-[2rem]">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {matchingArchetype.doWrite.map((phrase, index) => (
                  <li key={index} className="text-success-foreground bg-success/10 border border-success/30 p-3 rounded-lg">
                    "{phrase}"
                  </li>
                ))}
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3">
                {matchingArchetype.dontWrite.map((phrase, index) => (
                  <li key={index} className="text-destructive-foreground bg-destructive/10 border border-destructive/30 p-3 rounded-lg">
                    "{phrase}"
                  </li>
                ))}
              </ul>
            ...
            >
              ...
              <div className="flex flex-col gap-4">
                <button 
                  ...
                  type="button"
                  className="w-full flex items-center justify-center gap-2 bg-background/50 backdrop-blur-sm text-primary border-2 border-primary px-6 py-3 rounded-full hover:bg-primary/10 transition-colors"
                >
